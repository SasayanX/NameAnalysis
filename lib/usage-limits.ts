...
export function getUpgradeMessage(feature: keyof UsageLimits, currentPlan: string): string {
  const messages = {
    personalAnalysis: {
      free: "🔒 個人名分析の無料回数を使い切りました。<br/>💎 ベーシックプラン（330円/月）で無制限利用できます。",
      basic: "🔒 個人名分析の制限に達しました。<br/>💎 プレミアムプラン（550円/月）で無制限利用できます。",
    },
    companyAnalysis: {
      free: "🔒 会社名分析の無料回数を使い切りました。<br/>💎 ベーシックプラン（330円/月）で無制限利用できます。",
      basic: "🔒 会社名分析の制限に達しました。<br/>💎 プレミアムプラン（550円/月）で無制限利用できます。",
    },
    babyNaming: {
      free: "👶 赤ちゃん名付けの無料回数を使い切りました。<br/>💎 ベーシックプラン（330円/月）で無制限利用できます。",
      basic: "👶 赤ちゃん名付けの制限に達しました。<br/>💎 プレミアムプラン（550円/月）で無制限利用できます。",
    },
    csvExport: {
      free: "📄 CSVエクスポートは有料プランの機能です。<br/>💎 ベーシックプラン（330円/月）で利用できます。",
      basic: "📄 CSVエクスポートの制限に達しました。<br/>💎 プレミアムプラン（550円/月）で無制限利用できます。",
    },
    pdfExport: {
      free: "💾 PDFエクスポートは有料プランの機能です。<br/>💎 ベーシックプラン（330円/月）で利用できます。",
      basic: "💾 PDFエクスポートの制限に達しました。<br/>💎 プレミアムプラン（550円/月）で無制限利用できます。",
    },
  }
