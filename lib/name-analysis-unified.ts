...
export class UnifiedNameAnalyzer {
  ...
  private static getFortune(strokeCount: number): {
    ...
    const fortuneTable = new Map<number, { fortune: string; score: number; description: string }>([
      ...
      [3, { fortune: "大吉", score: 95, description: "創造力と表現力に優れた大吉数。明るく積極的な性格で、周囲から親しみやすく慕われます。頭脳明晰で先見の明もあり、あらゆる分野で成功を収める可能性があります。芸術的才能にも恵まれています。" }],
      [4, { fortune: "凶", score: 25, description: "真面目で努力家ですが、苦労が多い傾向があります。地道な努力を重ねることで道が開けますが、時には柔軟性も必要です。安定を求める気持ちが強く、変化を嫌う面があります。" }],
      [5, { fortune: "大吉", score: 90, description: "自由と変化を好む大吉数。バランス感覚に優れ、多方面での活躍が期待できます。好奇心旺盛で、新しいことに挑戦する勇気があります。適応力が高く、どんな環境でも力を発揮できます。" }],
      [6, { fortune: "大吉", score: 85, description: "調和と安定をもたらす大吉数。家庭運に恵まれ、周囲との関係も良好です。責任感が強く、家族思いの性格です。人望に恵まれ、信頼される存在として成長していきます。" }],
      [7, { fortune: "吉", score: 70, description: "内省的で分析力に優れています。独立心があり、専門分野で成功する可能性があります。神秘的な力を持ち、直感力も鋭いです。精神面での充実を心がけることで、より良い結果を得られます。" }],
      [8, { fortune: "大吉", score: 80, description: "物質的な成功と豊かさをもたらす大吉数。意志が強く、困難を乗り越える力があります。経済面での安定が期待でき、事業運にも恵まれています。組織運営の才能もあります。" }],
      ...
      [11, { fortune: "大吉", score: 75, description: "直感力と洞察力に優れた大吉数。霊感が強く、人々の心を読み取る能力があります。創造性に富み、芸術的才能にも恵まれています。精神的な成長を重ねることで、より高い次元での成功を収めます。" }],
      [12, { fortune: "吉", score: 60, description: "実践的で堅実な性格です。地道な努力が実を結び、安定した人生が期待できます。協調性があり、チームワークを大切にします。責任感が強く、信頼される存在として成長していきます。" }],
      [13, { fortune: "大吉", score: 70, description: "知恵と知識を重んじる大吉数。学習能力が高く、継続的な努力で大きな成果を上げます。指導力があり、後輩や部下を育てる才能に恵まれています。学問や研究分野での成功が期待できます。" }],
      [14, { fortune: "凶", score: 25, description: "変化と挑戦の数です。困難に直面することもありますが、それを乗り越える力も持っています。柔軟性と適応力が重要で、状況に応じて戦略を変えることが成功の鍵となります。" }],
      [15, { fortune: "大吉", score: 65, description: "家庭運と人望に恵まれた大吉数。温厚で親しみやすい性格で、多くの人から愛されます。家族思いで、家庭の平和を大切にします。社交性があり、良好な人間関係を築くことができます。" }],
      [16, { fortune: "大吉", score: 60, description: "責任感と指導力を持つ大吉数。組織をまとめる才能に恵まれ、リーダーとして活躍できます。誠実で信頼される存在として成長していきます。事業運にも恵まれ、経済的な成功が期待できます。" }],
      ...
      [21, { fortune: "大吉", score: 55, description: "独立心と独創性に富んだ大吉数。新しいアイデアを生み出す才能に恵まれています。リーダーシップがあり、周囲を引っ張っていく力があります。創造的な分野での成功が期待できます。" }],
      ...
      [23, { fortune: "大吉", score: 50, description: "芸術的才能と美的感覚に優れた大吉数。創造力が豊かで、表現力にも恵まれています。芸術や文化の分野での成功が期待できます。感性が鋭く、美しいものを愛する心があります。" }],
      [24, { fortune: "大吉", score: 45, description: "温和で協調性のある大吉数。人との調和を大切にし、平和を愛する性格です。家庭運に恵まれ、安定した幸せな家庭を築くことができます。人望に恵まれ、多くの人から愛されます。" }],
      [25, { fortune: "大吉", score: 40, description: "柔軟性と適応力に優れた大吉数。変化に対応する能力が高く、どんな環境でも力を発揮できます。バランス感覚が良く、安定した人生を送ることができます。社交性があり、良好な人間関係を築けます。" }],
      ...
      [29, { fortune: "大吉", score: 35, description: "知性と判断力に長けた大吉数。学習能力が高く、継続的な努力で大きな成果を上げます。指導力があり、後輩や部下を育てる才能に恵まれています。学問や研究分野での成功が期待できます。" }],
      [30, { fortune: "凶", score: 30, description: "変化と挑戦の数です。困難に直面することもありますが、それを乗り越える力も持っています。柔軟性と適応力が重要で、状況に応じて戦略を変えることが成功の鍵となります。" }],
      [31, { fortune: "大吉", score: 30, description: "誠実で信頼される大吉数。責任感が強く、約束を守ることを大切にします。人望に恵まれ、多くの人から信頼されます。安定した人生を送ることができ、長期的な成功が期待できます。" }],
      [32, { fortune: "大吉", score: 25, description: "社交性と人気に恵まれた大吉数。コミュニケーション能力が高く、多くの人と良好な関係を築くことができます。人望に恵まれ、リーダーとして活躍する可能性があります。チームワークを発揮できる場面では、実力を発揮することができます。" }],
      [33, { fortune: "大吉", score: 20, description: "創造力と表現力が豊かな大吉数。芸術的才能に恵まれ、表現力にも優れています。感性が鋭く、美しいものを愛する心があります。創造的な分野での成功が期待できます。" }],
      [34, { fortune: "凶", score: 25, description: "変化と挑戦の数です。困難に直面することもありますが、それを乗り越える力も持っています。柔軟性と適応力が重要で、状況に応じて戦略を変えることが成功の鍵となります。" }],
      [35, { fortune: "大吉", score: 15, description: "温和で協調性のある大吉数。人との調和を大切にし、平和を愛する性格です。家庭運に恵まれ、安定した幸せな家庭を築くことができます。人望に恵まれ、多くの人から愛されます。" }],
      [36, { fortune: "凶", score: 20, description: "変化と適応の数です。状況に応じて柔軟に対応する能力がありますが、時として不安定さを感じることもあります。バランスを保つことが重要で、周囲との調和を心がけることで成功できます。" }],
      [37, { fortune: "大吉", score: 10, description: "知恵と知識を重んじる大吉数。学習能力が高く、継続的な努力で大きな成果を上げます。指導力があり、後輩や部下を育てる才能に恵まれています。学問や研究分野での成功が期待できます。" }],
      [38, { fortune: "凶", score: 15, description: "変化と挑戦の数です。困難に直面することもありますが、それを乗り越える力も持っています。柔軟性と適応力が重要で、状況に応じて戦略を変えることが成功の鍵となります。" }],
      [39, { fortune: "大吉", score: 5, description: "責任感と指導力を持つ大吉数。組織をまとめる才能に恵まれ、リーダーとして活躍できます。誠実で信頼される存在として成長していきます。事業運にも恵まれ、経済的な成功が期待できます。" }],
      [40, { fortune: "凶", score: 10, description: "変化と適応の数です。状況に応じて柔軟に対応する能力がありますが、時として不安定さを感じることもあります。バランスを保つことが重要で、周囲との調和を心がけることで成功できます。" }],
      [41, { fortune: "大吉", score: 0, description: "独立心と独創性に富んだ大吉数。新しいアイデアを生み出す才能に恵まれています。リーダーシップがあり、周囲を引っ張っていく力があります。創造的な分野での成功が期待できます。" }],
    ])
    ...
    if (strokeCount >= 42 && strokeCount <= 50) {
      return { fortune: "吉", score: 50, description: "基本的な運勢を持ち、安定した人生を送ることができます。努力を重ねることで、より良い結果を得ることができます。周囲との調和を大切にし、協調性を発揮することで成功できます。" }
    }
    if (strokeCount >= 51 && strokeCount <= 60) {
      return { fortune: "中吉", score: 40, description: "安定した運勢を持ち、着実に成長していくことができます。継続的な努力が実を結び、長期的な成功が期待できます。バランス感覚が良く、安定した人生を送ることができます。" }
    }
    if (strokeCount >= 61 && strokeCount <= 70) {
      return { fortune: "小吉", score: 30, description: "穏やかな運勢を持ち、平和な人生を送ることができます。周囲との調和を大切にし、良好な人間関係を築くことができます。安定を求める気持ちが強く、変化を嫌う面があります。" }
    }
